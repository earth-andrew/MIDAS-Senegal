...
%If any agent already has a selectable higher-income layer, remove lower-income layer
%from consideration
%currentSelectable = find(selectable);
%achievedPrereqs = find(neededTraining(currentSelectable,:));
%selectable(achievedPrereqs) = 0;
