...
modelParameters.utility_k = 5.155; 
modelParameters.utility_m = 5.362; 
...
modelParameters.testsimpleFlag = 1;
...
modelParameters.expansionSlots = modelParameters.educationSlots; %Number of additional slots to be created as a result of ed expansion policy
...
modelParameters.ruralUrbanTime = 0.2242; %Round 1: 0.15; %Proportion of time needed for transit between rural and urban layers of portfolio
mapParameters.movingCostPerMile = 61625; %Round 1: 5725
mapParameters.minDistForCost = 50;
mapParameters.maxDistForCost = 400;
networkParameters.networkDistanceSD = 7;
networkParameters.connectionsMean = 10; %Round 1: 8
...
agentParameters.incomeShareFractionMean = 0.303; %Round 1: 0.225
...
agentParameters.discountRateMean = 0.2803; %Round 1: 0.24
