...
modelParameters.utility_k = 6.108; %Original value: 4; %Round 1: 5.36
modelParameters.utility_m = 6.604; %Round 1: 7.40
...
modelParameters.educationCost = 35865; %Round 1: 45,000
...
modelParameters.ruralUrbanTime = 0.2025; %Round 1: 0.15; %Proportion of time needed for transit between rural and urban layers of portfolio
mapParameters.movingCostPerMile = 3988; %Round 1: 5725
mapParameters.minDistForCost = 50;
mapParameters.maxDistForCost = 400;
networkParameters.networkDistanceSD = 7;
networkParameters.connectionsMean = 11; %Round 1: 8
...
agentParameters.incomeShareFractionMean = 0.4575; %Round 1: 0.225
...
agentParameters.numPeriodsEvaluateMean = 12;
agentParameters.numPeriodsEvaluateSD = 0;
agentParameters.numPeriodsMemoryMean = 21; %Round 1: 22
agentParameters.numPeriodsMemorySD = 0;
agentParameters.discountRateMean = 0.176; %Round 1: 0.24
