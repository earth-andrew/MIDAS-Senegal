...
modelParameters.utility_k = 5.2713; 
modelParameters.utility_m = 5.3246; 
...
modelParameters.ruralUrbanTime = 0.2294; %Round 1: 0.15; %Proportion of time needed for transit between rural and urban layers of portfolio
mapParameters.movingCostPerMile = 5725; %Round 1: 5725
mapParameters.minDistForCost = 50;
mapParameters.maxDistForCost = 400;
networkParameters.networkDistanceSD = 7;
networkParameters.connectionsMean = 12; %Round 1: 8
...
modelParameters.educationFile = './Data/SenegalEducationProbability.csv';
modelParameters.climateFile = './Data/SenegalSaltwaterIntrusionFile.csv';
...
agentParameters.incomeShareFractionMean = 0.4342; %Round 1: 0.225
...
agentParameters.bestPortfolioMean = 3;
...
agentParameters.numPeriodsEvaluateMean = 21;
...
agentParameters.discountRateMean = 0.2732; %Round 1: 0.24
...
agentParameters.prospectLossMean = 2.5713;
